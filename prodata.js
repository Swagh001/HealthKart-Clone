...
let nevbardiv = document.getElementById("navbar-container");
...
function display() {
  ...
  smallimg2.addEventListener("click", () => {
    ...
    document.getElementById("small-image2").style.border = "2px solid orange";
    document.getElementById("small-image3").style.border = "none";

    document.getElementById("small-image4").style.border = "none";
  ...
  smallimg3.addEventListener("click", () => {
    ...
    document.getElementById("small-image3").style.border = "2px solid orange";
    document.getElementById("small-image2").style.border = "none";
    document.getElementById("small-image4").style.border = "none";
  ...
  smallimg4.addEventListener("click", () => {
    ...
    document.getElementById("small-image3").style.border = "none";
    document.getElementById("small-image2").style.border = "none";
    document.getElementById("small-image4").style.border = "2px solid orange";
  })
